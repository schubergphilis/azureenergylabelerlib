...
Ready to contribute? Here's how to set up `azureenergylabelerlib` for local development.
Using of pipenv is highly recommended.

1. Clone your fork locally::

    $ git clone https://enx.gitlab.schubergphilis.com/python/azureenergylabelerlib
